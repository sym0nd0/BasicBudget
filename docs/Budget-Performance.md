...
The Overview and Trends sections of the [[Reports]] page provide a high-level picture of your financial performance over the selected time range.

## Overview Cards

Five summary cards appear at the top of the Reports page, each with a trend indicator (up/down arrow compared to the previous equivalent period):
...
A grouped bar chart showing monthly income and expenses side by side.

- Each month appears as a pair of bars (income in one colour, expenses in another)
