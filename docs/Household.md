...
Each user belongs to at most one household. A household has:
...
| Role | Capabilities |
|---|---|
| **Owner** | Can invite members, remove members, and manage the household. |
...
The `/household` page shows a combined view of all household-flagged items:

- **Income** — all members' household income
- **Expenses** — all members' household expenses
